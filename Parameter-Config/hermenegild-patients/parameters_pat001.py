...
class Parameters():
	...
	#self.filename='LV_Purkinje'
        #self.init_node=np.array([92.9401,103.272,-15.9869])  
        #self.second_node=np.array([93.3021,102.481,-39.5479])

	# right ventricle patient 1
	#self.filename='RV_Purkinje'
	#self.init_node=np.array([43.085,70.5274,2.9596])
...
#Median length of the branches
        self.length=4		 				#self.length =.3				# 3 works, should be longer
